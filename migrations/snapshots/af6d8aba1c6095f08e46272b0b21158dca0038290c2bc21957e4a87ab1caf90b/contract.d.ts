...
export type StorageHash =
  StorageHashBase<'af6d8aba1c6095f08e46272b0b21158dca0038290c2bc21957e4a87ab1caf90b'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly Guest: {
      ...
      readonly publicToken: CodecTypes['pg/text@1']['output'];
      readonly rsvpStatus: 'PENDING' | 'CONFIRMED' | 'DECLINED';
...
export type FieldInputTypes = {
  readonly public: {
    readonly Guest: {
      ...
      readonly publicToken: CodecTypes['pg/text@1']['input'];
      readonly rsvpStatus: 'PENDING' | 'CONFIRMED' | 'DECLINED';
        ...
        readonly entries: {
          readonly table: {
            readonly guest: {
              ...
              uniques: readonly [{ readonly columns: readonly ['publicToken'] }];
              indexes: readonly [];
          ...
          readonly valueSet: {
            readonly RsvpStatus: {
              ...
              readonly values: readonly ['PENDING', 'CONFIRMED', 'DECLINED'];
            };
          };
        };
      };
          ...
          readonly Guest: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly publicToken: { readonly column: 'publicToken' };
